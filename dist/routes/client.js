...
router.get("/", (0, permission_1.requirePermission)("clients:read"), async (req, res, next) => {
    try {
...
router.post("/", (0, permission_1.requirePermission)("clients:write"), (0, validate_1.validateBody)(schemas_1.createClientSchema), async (req, res, next) => {
    try {
        const tenantId = req.tenantId;
