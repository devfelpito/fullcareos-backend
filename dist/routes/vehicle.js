...
router.get("/", (0, permission_1.requirePermission)("vehicles:read"), async (req, res, next) => {
    try {
...
router.post("/", (0, permission_1.requirePermission)("vehicles:write"), (0, validate_1.validateBody)(schemas_1.createVehicleSchema), async (req, res, next) => {
    try {
        const tenantId = req.tenantId;
