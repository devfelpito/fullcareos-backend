...
export default function CustomerResetPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const res = await fetch(`${API_URL}/customer-auth/${companySlug}/reset-password`, {
      method: "POST",
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-10">
      <h1 className="text-2xl font-semibold text-primary">Redefinir senha</h1>
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4 rounded-xl border border-ice-border bg-white p-6 shadow-sm">
        ...
        <button type="submit" className="w-full rounded-lg bg-accent px-4 py-2.5 font-medium text-white">Redefinir senha</button>
      </form>
